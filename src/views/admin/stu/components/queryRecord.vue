  ...
  >
    ...
    >
      <template slot-scope="scope">
        <el-tag
          size="mini"
          type="success qcx-label__dorm"
          v-if="scope.row.detailCategory === '宿舍文明'"
        >宿舍文明</el-tag>
        <el-tag
          size="mini"
          type="danger qcx-label__class"
          v-else-if="scope.row.detailCategory === '课堂文明'"
        >课堂文明</el-tag>
        <el-tag
          size="mini"
          type="primary qcx-label__net"
          v-else-if="scope.row.detailCategory === '网络文明'"
        >网络文明</el-tag>
